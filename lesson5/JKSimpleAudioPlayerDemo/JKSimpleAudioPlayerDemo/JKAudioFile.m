...
- (NSArray *)parseData:(BOOL *)isEof
{
    ...
    if (ioNumPackets > 0)
    {
        ...
        for (int i = 0; i < ioNumPackets; ++i)
        {
            ...
            JKParsedAudioData *parsedData = [JKParsedAudioData parseAudioDataWithBytes:outBuffer + packetDescription.mStartOffset packetDescription:packetDescription];
            if (parsedData)
            {
...
static OSStatus MCAudioFileReadCallBack(void *inClientData,
                                        ...
                                        UInt32 *actualCount)
{
    JKAudioFile *audioFile = (__bridge JKAudioFile *)inClientData;
