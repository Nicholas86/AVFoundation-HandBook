...
@interface AppDelegate ()<JKAudioFileStreamDelegate> {
@private
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _audioFileStream = [[JKAudioFileStream alloc] initWithFileType:kAudioFileMP3Type fileSize:fileSize error:&error];
